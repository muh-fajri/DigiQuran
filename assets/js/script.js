            ...
            if((`${surah.number}` == '1') || (`${surah.number}` == '9')) {
                $('#surah-content').append(`
                    <div class="title" style="text-align:center">
                        ...
                        <p style="margin:25px;font-size:14px;font-style:italic">
                            <span>${surah.tafsir.id}</span>
                        </p>
                    </div>
                `);
            } else {
                    ...
                    $('#surah-content').append(`
                        <div class="detail">
                            <p class="meta">
                                ...
                                <a class="tafsir" title="Lihat Tafsir">
                            ...
                            <div class="tafsir-text" style="display:none; padding: 15px; border-left: 3px solid #27ae60; background: #f9f9f9; margin-top: 10px; font-style: italic;">
                ...
                if (currentIndex < verses.length) {
                    $('#surah-content').append(`
                        <div id="load-more-container" style="text-align:center; padding: 20px;">
                            <button id="btn-load-more" style="padding: 10px 20px; background: #27ae60; color: white; border: none; border-radius: 5px; cursor: pointer; min-width: 180px;">
...
/* 1. Event Click untuk Tafsir (Ubah Ikon Buku) */
$('#surah-content').on('click', '.tafsir', function() {
    const container = $(this).closest('.detail').find('.tafsir-text');
    const icon = $(this).find('.fas'); // Mencari ikon di dalam tombol yang diklik

    container.slideToggle(300, function() {
        // Cek apakah kontainer sekarang terlihat atau tersembunyi
...
/* 2. Event Click untuk Audio (Ubah Ikon Play/Pause) */
